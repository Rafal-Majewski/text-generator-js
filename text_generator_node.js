...
TextGenerator.prototype._exampleIterator=function(example, func) {
...
TextGenerator.prototype._learn=function(weights, example, origin, multiplier) {
...
TextGenerator.prototype._forget=function(weights, example, origin, multiplier) {
	this._exampleIterator(example, (from, to)=>{
		if (weights[origin][from] == undefined) weights[origin][from]={};
		if (weights[origin][from][to] == undefined) weights[origin][from][to]=0;
		weights[origin][from][to]-=multiplier;
...
TextGenerator.prototype.learnLeft=function(example, origin, multiplier, isRaw) {
	this._learn(
		this.weightsLeft,
...
TextGenerator.prototype.learnBoth=function(example, origin, multiplier, isRaw) {
	this._learn(
		this.weightsLeft,
		[...(isRaw)?(""):(this.endingCharacter), ...example, ...(isRaw)?(""):(this.startingCharacter)].reverse(),
		origin || "_default",
...
TextGenerator.prototype.learnRight=function(example, origin, multiplier, isRaw) {
	this._learn(
		this.weightsRight,
		[...(isRaw)?(""):(this.startingCharacter), ...example, ...(isRaw)?(""):(this.endingCharacter)],
		origin || "_default",
...
TextGenerator.prototype.forgetBoth=function(example, origin, multiplier, isRaw) {
	this._forget(
		this.weightsLeft,
		[...(isRaw)?(""):(this.endingCharacter), ...example, ...(isRaw)?(""):(this.startingCharacter)].reverse(),
		origin || "_default",
...
TextGenerator.prototype.forgetLeft=function(example, origin, multiplier, isRaw) {
	this._forget(
		this.weightsLeft,
		[...(isRaw)?(""):(this.endingCharacter), ...example, ...(isRaw)?(""):(this.startingCharacter)].reverse(),
		origin || "_default",
...
TextGenerator.prototype.forgetRight=function(example, origin, multiplier, isRaw) {
	this._forget(
		this.weightsRight,
		[...(isRaw)?(""):(this.startingCharacter), ...example, ...(isRaw)?(""):(this.endingCharacter)],
		origin || "_default",
...
TextGenerator.prototype._getNexts=function(weights, text, origins, safe) {
	let nexts={};
	let sum=0;
	let from=text;
...
TextGenerator.prototype._chooseNext=function(nexts, pick) {
...
TextGenerator.prototype._predict=function(weights, splittedText, origins, obeyLimit, safe) {
...
TextGenerator.prototype.predictRight=function(text, origins, isRaw, obeyLimit) {
	if (!text) text="";
...
TextGenerator.prototype.predictLeft=function(text, origins, isRaw) {
	if (!text) text="";
	return this._predict(
		this.weightsLeft,
...
TextGenerator.prototype.generateRight=function(text, origins, isRaw) {
	if (!text) text="";
...
TextGenerator.prototype.generateBoth=function(text, origins) {
	if (!text) text="";
...
TextGenerator.prototype._shrink=function(weights, origins) {
	for (let origin of origins) {
		if (!weights[origin]) continue;
...
TextGenerator.prototype.shrinkLeft=function(origins) {
	this._shrink(this.weightsLeft, origins || Object.keys(this.weightsLeft));
};

TextGenerator.prototype.shrinkRight=function(origins) {
	this._shrink(this.weightsRight, origins || Object.keys(this.weightsRight));
};

TextGenerator.prototype.shrinkBoth=function(origins) {
	this._shrink(this.weightsLeft, origins || Object.keys(this.weightsLeft));
	this._shrink(this.weightsRight, origins || Object.keys(this.weightsRight));
};


TextGenerator.prototype.saveToJson=function() {return JSON.stringify(this);};
TextGenerator.prototype.loadFromJson=function(json) {
...
TextGenerator.prototype.saveWeightsToJson=function() {
	return JSON.stringify({weightsLeft: this.weightsLeft, weightsRight: this.weightsRight});
};
TextGenerator.prototype.loadWeightsFromJson=function(json) {
	let weights=JSON.parse(json);
	this.weightsLeft=weights.weightsLeft;
	this.weightsRight=weights.weightsRight;
};

TextGenerator.prototype.predict=TextGenerator.prototype.predictRight;
TextGenerator.prototype.learn=TextGenerator.prototype.learnRight;
TextGenerator.prototype.forget=TextGenerator.prototype.forgetRight;
TextGenerator.prototype.generate=TextGenerator.prototype.generateRight;
TextGenerator.prototype.shrink=TextGenerator.prototype.shrinkBoth;

TextGenerator.prototype.generateLeft=function(text, origins, isRaw) {
	if (!text) text="";
...
TextGenerator.prototype._validate=function(weights, text, origins) {
	let sum=0;
	let all=0;
